...
# Set path to motioncorr installation
MOTIONCOR="/opt/MotionCor2/MotionCor2_1.4.7_Cuda115_12-09-2021"

# Setup file extensions used. Usually "st" or "mrc"
TS_EXTENSION="st"

# Setup GPUs to use. For one GPU systems, typically use "0", for two GPU systems, use "0 1"
GPU="0 1"


#################### DO NOT CHANGE ANYTHING UPON THIS POINT ####################
...
eval $MOTIONCOR -Patch 7 5 -Iter 10 -Tol 0.5 -SplitSum 1 -Ftbin 2 -Serial 1 -Gpu $GPU -Gain ./01_raw_data/frames/GainRef.mrc -InTiff ./01_raw_data/frames/TS_ -OutMrc ./.motioncor2_temp/01_aligned_tilts/TS_
